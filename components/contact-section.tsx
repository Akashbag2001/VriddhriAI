...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="relative py-24 lg:py-32 bg-[#05051a] overflow-hidden">
      {/* Gradient bg */}
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center text-white/50 hover:text-white hover:border-white/20 hover:bg-white/10 transition-all"
                >
                  {social.icon}
                </a>
              ))}
          ...
          >
            {submitted ? (
              ...
              <form
                ...
                className="rounded-3xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-sm p-8 space-y-5"
              >
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-white/[0.05] border border-white/[0.08] text-white placeholder:text-white/20 focus:outline-none focus:border-violet-500/50 focus:bg-white/[0.08] transition-all"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label htmlFor="contact-project" className="block text-white/60 text-sm font-medium mb-2">
                    Project Type
                  </label>
                  <select
                    id="contact-project"
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/[0.05] border border-white/[0.08] text-white focus:outline-none focus:border-violet-500/50 focus:bg-white/[0.08] transition-all appearance-none"
                  >
                    <option value="" className="bg-[#06061e]">Select project type...</option>
                    <option value="website" className="bg-[#06061e]">Website / Landing Page</option>
                    <option value="ecommerce" className="bg-[#06061e]">E-Commerce Store</option>
                    <option value="webapp" className="bg-[#06061e]">Web Application</option>
                    <option value="redesign" className="bg-[#06061e]">Redesign / Rebrand</option>
                    <option value="other" className="bg-[#06061e]">Other</option>
                  </select>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/[0.05] border border-white/[0.08] text-white placeholder:text-white/20 focus:outline-none focus:border-violet-500/50 focus:bg-white/[0.08] transition-all resize-none"
                  />
                </div>
